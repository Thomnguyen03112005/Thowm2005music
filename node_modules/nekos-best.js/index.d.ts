...
declare const GIF_CATEGORIES: readonly ["baka", "bite", "blush", "bored", "cry", "cuddle", "dance", "facepalm", "feed", "happy", "highfive", "hug", "kiss", "laugh", "pat", "pout", "shrug", "slap", "sleep", "smile", "smug", "stare", "think", "thumbsup", "tickle", "wave", "wink", "kick", "handhold", "punch", "shoot", "yeet", "poke", "nod", "nom", "nope"];
declare type Nullable<T> = T | undefined | null;
export declare type NbCategories = typeof GIF_CATEGORIES[number] | typeof IMAGE_CATEGORIES[number];
/** @deprecated This will be removed in the next major version */
export declare type NbEndpointMetadata = Record<string, {
    format: string;
    min: string;
    max: string;
}>;
export declare type NbIndividualResponse = {
    artist_href?: string;
    artist_name?: string;
    source_url?: string;
    anime_name?: string;
...
export declare type NbResponse = {
    results: NbIndividualResponse[];
};
export declare type NbBufferResponse = NbIndividualResponse & {
    data: Buffer;
};
export declare type RatelimitHandleMode = "sleep" | "throw";
